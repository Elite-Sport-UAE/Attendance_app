...
try:
    athlete_df = pd.read_excel(lookup_excel_path, sheet_name="athlete_names", engine="openpyxl")
    coach_df = pd.read_excel(lookup_excel_path, sheet_name="coach_names", engine="openpyxl")
    sport_df = pd.read_excel(lookup_excel_path, sheet_name="sport", engine="openpyxl")
    training_type_df = pd.read_excel(lookup_excel_path, sheet_name="training_type", engine="openpyxl")
    location_df = pd.read_excel(lookup_excel_path, sheet_name="location", engine="openpyxl")
    reason_df = pd.read_excel(lookup_excel_path, sheet_name="reason_absence", engine="openpyxl")

    st.success("Excel file loaded successfully")

except PermissionError:
    st.error("Permission denied reading the Excel file. Close it in Excel and try again.")
    st.stop()
